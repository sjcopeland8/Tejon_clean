...
```{r}
threeyrs <- read_csv("raw_data/Total_Ticks_2016_to_2018.csv")
dim(threeyrs)
oneyr <- read_csv("raw_data/Tick_19.csv")
dim(oneyr)
...
############## temperature ##############
temp <- read_csv("raw_data/Tejon_temperature_02022021.csv")
...
precip <- read_csv("raw_data/tejon_tick_climate_10162020.csv")
...
mam <- read_csv("raw_data/tejon_mammal_02022021.csv")
...
pop_estimates <-read_csv("raw_data/tejon_mamliz_popestimates.csv")

...
#using different optimizers provided similar results in terms of the likelihood of the data

#residual plot
plot(mod_2_4, which = 1, type = "pearson")

plot(mod_2_4_2, which = 2, type = "pearson")
...
AIC(mod_2_1, mod_2_2, mod_2_3, mod_2_4_2) # mod_4 lowest, but mod_3 also good

anova(mod_2_3, mod_2_4_2) # mod4 better
...
AIC(mod_2_4_2, mod_2_5, mod_2_6) # mod4 still better
